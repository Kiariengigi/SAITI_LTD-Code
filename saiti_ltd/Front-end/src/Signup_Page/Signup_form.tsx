...
function Signup_form() {
  ...
  const USER_REGEX = /^[a-zA-Z\s'-]{2,100}$/
    ...
    if (success) {
     ...
     return (
    <section className="signup-card simple-signup-card">
      <p
        ref={errRef}
        className={errMsg ? "errmsg signup-error" : "offscreen"}
        aria-live="assertive"
      >
        {errMsg}
      </p>

      <div className="signup-header simple-header">
        <h1>Register</h1>
      ...
      <form onSubmit={handleSubmit} className="signup-form">
        ...
        <label htmlFor="email" className="signup-label">
          E-mail
          <span className="signup-validity">
            <FontAwesomeIcon icon={faCheck} className={validName && email ? "valid" : "hide"} />
        ...
        <p id="pwdnote" className={pwdFocus && !validPwd ? "instructions" : "offscreen"}>
          <FontAwesomeIcon icon={faInfoCircle} />
          8 to 24 characters with upper and lower case letters, a number, and a special character.
        </p>
